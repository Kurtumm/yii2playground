...
use Yii;
use app\models\yii2playground\Geography;
use app\models\yii2playground\search\Geography as GeographySearch;
...
class GeographyController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['view', 'id' => $model->geographyId]);
        } else {
